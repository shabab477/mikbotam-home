...
<input class="jscolor form-control" value="<?=$datajson[3]['Color'];?>" name="Color_4">
                        ...
                        <div class="row mg-t-8">
                                ...
                                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                     <div class="input-group">
                                <input type="number" name="limit_download_5" class="form-control  boxsadaw"  value="<?php if (!empty($datajson[4]['limit_download'])) { echo $datajson[4]['limit_total'];} else { echo '0';}?>">
                                <span class="input-group-addon">Mbps</span>
                            </div>
                                </div>
                            </div>
